<template>
    <div id='post' class="flex border-b py-6">
        <div @click="isLoggedIn(post.user)" class="cursor-pointer">
            <img class="rounded-full max-h-[60px]" width="60" src="https://picsum.photos/id/300/320">
        </div>
        <div class="pl-3 w-full px-4">
            ...
            <div class="text-[15px] pb-0.5 break-words md:max-w-[400px] max-w-[300px]">This is for test</div>
                ...
                <div class="relative mr-[75px]">
                    <div class="absolute bottom-0 pl-2">
                        <div class="pb-4 text-center">
                            ...
                            <span class="text-xs text-gray-800 font-semibold">2</span>
                        </div>
                        <div class="pb-4 text-center">
