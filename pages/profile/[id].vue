        ...
        >
            <div class="flex w-[calc(100vw-230px)]">
                ...
                <div class="ml-5 w-full">
                    ...
                    <div class="text-[18px] truncate">Malya</div>
                    <button
                        v-if='true'
            ...
            <div class="pt-4 mr-4 text-gray-500 font-light text-[15px] pl-1.5 max-w-[500px]">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores, atque laudantium molestiae nihil obcaecati officia pariatur perspiciatis quaerat qui quidem. Architecto aut blanditiis dolore id nesciunt nostrum sequi sunt voluptate.
            </div>
